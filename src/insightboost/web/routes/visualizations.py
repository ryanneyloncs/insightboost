...
from insightboost.utils.exceptions import VisualizationError, DatasetError
...
@visualizations_bp.route("/datasets/<dataset_id>/visualizations/suggest", methods=["GET"])
...
def create_visualization(dataset_id: str):
    ...
    try:
        ...
        # Option 2: Use custom config
            ...
            # Validate chart type
            chart_type_str = validate_chart_type(config_data.get("chart_type", "scatter"))
...
@visualizations_bp.route("/datasets/<dataset_id>/visualizations/<viz_id>", methods=["GET"])
...
@visualizations_bp.route("/datasets/<dataset_id>/visualizations/<viz_id>", methods=["DELETE"])
...
@visualizations_bp.route("/datasets/<dataset_id>/visualizations/<viz_id>/export", methods=["GET"])
