...
from insightboost.core.data_analyzer import DataAnalyzer, DataProfile
...
from insightboost.utils.exceptions import DataValidationError, InsightGenerationError
...
class InsightsGenerator:
    ...
    def analyze_dataframe(
        ...
        try:
            ...
            logger.info(f"Analysis complete: {len(ai_analysis.insights)} insights, {len(ai_analysis.patterns)} patterns")
                ...
                if dist:
                    ...
                    if abs(dist.skewness) > 1:
                        ...
                        patterns.append(Pattern(
                            ...
                            details={"skewness": dist.skewness, "kurtosis": dist.kurtosis},
                        ))
                    ...
                    if dist.outlier_percentage > 5:
                        patterns.append(Pattern(
                            ...
                            details={"outlier_count": dist.outlier_count, "outlier_pct": dist.outlier_percentage},
                        ))
                ...
                if 2 <= cardinality <= 10:
                    ...
                    if dominant > 50:
                        patterns.append(Pattern(
                            ...
                            details={"dominant_value": str(value_counts.index[0]), "percentage": dominant},
                        ))
